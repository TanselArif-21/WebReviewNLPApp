...
class TopicModeling:
    ...
    def ldaModel(self, x = None, topics = None):
        '''
        ...
        if topics:
            ...
            coherence_model_lda = gensim.models.CoherenceModel(model=lda_model,
                    texts=x, dictionary=self.id2word, coherence='c_v',processes = 1)
            self.coherence_lda = coherence_model_lda.get_coherence()
            
            best_model = lda_model
            
            # Print progress
            print('\n The Coherence Score with {} topics is {}'.format(topics,self.coherence_lda))
        else:
            ...
            for i in range(2,3): 
                ...
                if max_coherence_score < self.coherence_lda:
                    max_coherence_score = self.coherence_lda
                    best_n_topics = i
                    best_model = lda_model

                # Print progress
                print('\n The Coherence Score with {} topics is {}'.format(i,self.coherence_lda))
    ...
    def ldaFromReviews(self, topics = None):
        '''
        ...
        self.ldamodel,self.ldavis = self.ldaModel(topics=topics)
